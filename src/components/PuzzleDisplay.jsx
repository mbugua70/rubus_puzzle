...
/**
 * Renders the current puzzle's two picture cards plus the joining "+".
 * Keyed by puzzle id so AnimatePresence treats each puzzle as a distinct
 * entry — the old pair fades out fully before the new pair fades in,
 * so the previous puzzle's images are never visible alongside the new one.
 */
